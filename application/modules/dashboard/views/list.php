<div class="page-breadcrumb">
		...
		<tr>  
			...
			<td><?php echo $u->lembap ?></td>
			
			<td><?php echo anchor('dashboard/edit/'.$u->id,'<button type="button" class="btn btn-primary text-center">Edit Data</button>'); ?>  <?php echo anchor('dashboard/hapus/'.$u->id,'<button type="button" class="btn btn-danger text-center">Hapus Data</button>'); ?></td>
            ...
            ?>
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label class="control-label col-xs-3" >suhu</label>
                        <div class="col-xs-9">
                           <input type="text" name="suhu">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-xs-3" >lembab</label>
                        <div class="col-xs-9">
                           <input type="text" name="lembap">
                        </div>
                    </div>
