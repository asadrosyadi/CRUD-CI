<div class="page-breadcrumb">
		...
		<tr>  
			...
			<td><?php echo anchor('tes/edit/'.$u->id,'<button type="button" class="btn btn-primary text-center">Edit Data</button>'); ?>  <?php echo anchor('tes/hapus/'.$u->id,'<button type="button" class="btn btn-danger text-center">Hapus Data</button>'); ?></td>
...
<!-- MODAL ADD -->
        <div class="modal fade" id="ModalaAdd" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
            ...
            <?php
            echo form_open_multipart('tes/add', 'role="form" class="form-horizontal"');
            ?>
